...
abstract class Bridge {
  Future<int> addThree({required int before, dynamic hint});

  FlutterRustBridgeTaskConstMeta get kAddThreeConstMeta;
}
...
class BridgeImpl implements Bridge {
  ...
  Future<int> addThree({required int before, dynamic hint}) {
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_add_three(port_, arg0),
...
class BridgeWire implements FlutterRustBridgeWireBase {
  ...
  void wire_add_three(
    ...
    return _wire_add_three(
      port_,
      before,
    );
  }

  late final _wire_add_threePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64, ffi.Int32)>>(
          'wire_add_three');
  late final _wire_add_three =
      _wire_add_threePtr.asFunction<void Function(int, int)>();
